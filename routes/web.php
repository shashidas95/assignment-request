...
Write the code to retrieve the value of the 'page' parameter from the current request and store it in a variable called $page. If the parameter is not present, set $page to null.
Question 4:
...
Route::post('/user', [DemoController::class, 'ShowName']);
Route::post('/user-agent', [DemoController::class, 'ShowUserAgent']);
Route::post('/page', [DemoController::class, 'ShowPage']);
